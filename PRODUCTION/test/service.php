<?php
    ...
    $result2                 = mysqli_query($connect, "SELECT id, effectif, debutservice, finservice, total, dernier, heure, minute, seconde, jour, adjusted FROM service WHERE effectif=$idEffectifActuel AND past=0");
...
<html>
            ...
            <tbody>
                <tr>
                    <td style="width: 33%; vertical-align: top;">
                        <div style="margin: 50px 50px 20px 50px; padding: 10px 10px 20px 10px; background-color: #aec3b0; border-radius: 10px;">
                            ...
                            <table style="width: 100%; color: #01161e;">
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="titleSummaryStyle">Agrégation(s) :</td>
                                        <td><?php echo $roleEffectifActuel;?></td>
                                    </tr>
                                    <tr>
                                        <td class="titleSummaryStyle">Unité(s) :</td>
                        ...
                        <span style="font-size: small;">Information : cette page est actualisée toutes les 45 secondes</span>
                    </td>
                    <td style="width: 34%;">
    ...
    <div id="tableEffectif" style="width: 100%; padding: 0px 25px; margin-bottom: 200px !important;">
        <table cellpadding="10px" cellspacing="10px" style="width: 100%; border-top: 2px solid white; font-size: smaller">
            <tr class="rowEffectifHeader" style="border-bottom: 2px solid white;">
                <th style="width: 13%">Prénom Nom</th>
                <th style="width: 10%">Grade</th>
                <th style="width: 15%">Agrégation(s)</th>
                <th style="width: 15%">Unité(s)</th>
            ...
            <?php
                ...
                echo "
                    <tr class='$rowAppliedClass'>
                        <td><div class='nameClass'><a>$prenom $nom<div><img class='profilePictureClass' src='" . $photo . "' width='100px' height='100px'/></div></a><div></td>
                        <td><div class='gradeClass'>$grade<div></td>
                        <td><div class='agregationClass'>$role<div></td>
                        <td><div class='unityClass'>$agregations<div></td>
                        <td><div class='phoneClass'>$phone<div></td>
                        <td><div class='statusClass'>$intervention<div></td>
                        <td><div class='commentClass'>$commentaire<div></td>
                        <td><div class='vehicleClass'>$vehicule<div></td>
                        <td><div class='startClass'>$debutservice<div></td>
                    </tr>
                ";
                $rank += 1;
                }
