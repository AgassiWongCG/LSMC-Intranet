...
//            echo $diff->s.' Seconds<br>';
        ...
        if (isset($_POST["button_Ajuster"])) {
            ...
            header("Location: ./serviceseffectif_test.php?effectifId=" . $cid . "&sucessAdjusted=true");
        }
    ?>
                ...
                <tr>
                    ...
                    <td style="width: 34%;">
                        <div style="margin: 50px 50px 50px 50px; padding: 10px 10px 20px 10px; background-color: #dcc1e9; border-radius: 10px;">
                            <h4 class="bold underline" style="padding: 10px; color: #01161e;">Total de sa semaine</h4>
                        ...
                        <?php if($data["timemanager"] === '1') echo '<form method="post" action="./serviceseffectif_test.php" style="width: 100%; text-align: center;">
