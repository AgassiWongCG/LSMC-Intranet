...
<html>
    ...
    <?php
        ...
        $result2                = mysqli_query($connect, "SELECT id, effectif, debutservice, finservice, total, dernier, heure, minute, seconde, jour, firstname, lastname, status FROM service WHERE past=0 AND dernier = 0 AND toignore=0");
	...
	<body style="width: 100%; text-align: center;">
        ...
        <?php
            ...
            while ($row = mysqli_fetch_row($result)) {
                ...
                $nom                = ucfirst($row[11]);
                $status             = $row[12];
//                $newHeure           = round((strtotime($finservice) - strtotime($debutservice))/3600, 1);
